                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="col-lg-5 d-none d-lg-block "><div class="ajeita"><img src="../fotos/<?php print $row['cpf']; ?>_aluno.jpg" width="300" height="300"  position="absolute" left="130"  top="155"></div></div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <h5><b>Nome:</b> <?php print $row["nome"]; ?><br></h5>
                                                                
                                        <h5><b>Data de Nascimento:</b> <?php print $row["dataNascimento"]; ?><br></h5>
                                                                                              
                                        <h5><b>Sexo:</b> <?php print $row["sexo"]; ?><br></h5>
                                                                
                                        <h5><b>RG:</b> <?php print $row["rg"]; ?><br></h5>
                                                                
                                        <h5><b>CPF:</b> <?php print $row["cpf"]; ?><br></h5>
                                                                
                                        <h5><b>Graduação e ano:</b> <?php print $row["graduacao"]; ?><br></h5>   
                                                                                                                         
                                        <h5><b>Telefone(WhatsApp):</b> <?php print $row["telefone"]; ?><br></h5>
                                                                
                                        <h5><b>E-mail:</b> <?php print $row["email"]; ?><br></h5>
                                                                
                                        <h5><b>Responsável:</b> <?php print $row["responsavel"]; ?><br></h5>                                                           
                                                                
                                        <h5><b>Telefone - Responsável:</b> <?php print $row["telefoneResponsavel"]; ?><br></h5>
                                                                
                                        <h5><b>CPF Responsável:</b> <?php print $row["cpfResponsavel"]; ?><br></h5>
                                                                
                                        <h5><b>Email Responsável:</b> <?php print $row["emailResponsavel"]; ?><br></h5>                                                            
                                                                
                                        <h5><b>CEP:</b> <?php print $row["CEP"]; ?><br></h5>                                                            
                                                                
                                        <h5><b>Endereço:</b> <?php print $row["endereco"]; ?><br></h5>                                                            
                                                        
                                                        
                                                        
                                                        
                                                    <hr>
                                                    <a href="javascript:history.go(-1)" class="btn btn-primary btn-user btn-block">voltar</a>
