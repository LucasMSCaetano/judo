                                                ...
                                                <form action="../../back-end.php" method="POST"  enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php print $row["id"]; ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <input type="text" name="valor" value="<?php print $row["valor"]; ?>" class="form-control form-control-user" readonly>
                                                    ...
                                                    <a class="btn btn-primary btn-user btn-block" href="troca-senha.php">alterar senha</a>
