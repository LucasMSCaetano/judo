                                        ...
                                        <div class="p-5">
                                            <div class="text-center">
                                                ...
                                                <form action="../../back-end.php" method="POST"  enctype="multipart/form-data">
                                                    <input type="hidden" name="acao" value="troca-senha">
                                                    <input type="hidden" name="id" value="<?php print $row["id"]; ?>">
                                                        <div class="form-group row">
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <label>Nova senha</label>
                                                                <input type="password" name="troca" class="form-control form-control-user" >
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>Confirmar Nova senha</label>
                                                                <input type="password" name="" class="form-control form-control-user" >
                                                            </div>
                                                        </div>
