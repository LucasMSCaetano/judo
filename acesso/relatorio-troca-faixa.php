                            ...
                            <div class="col-lg-7">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Certificado Troca de faixa</h1>
                                </div>
                                    
                                <form class="user" method="POST" action="fpdf/relatorios/certificado.php">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <select id='select' name="nomeAluno" class="form-control "  required>
                                                <option value='' selected>Escolha um aluno</option>

                                                <?php
                                                include("../conexao.php");
                                                $result_pesquisa = "SELECT DISTINCT `nome` FROM `judo` order by `nome` ASC";
                                                $resultado_niveis_acesso = mysqli_query($conn, $result_pesquisa);
                                                while($row_pesquisa = mysqli_fetch_assoc($resultado_niveis_acesso)){ 
                                        
                                                    ?>
                                                    <option value="<?php echo $row_pesquisa['nome']; ?>"><?php echo $row_pesquisa['nome']; ?></option> 
                                                <?php
                                                }
                                                ?>        
                                            </select>
                                        ...
                                        <div class="col-sm-6 ">
                                            <div class="form-group">
                                                ...
                                                <select id='select' name="faixa" class="form-control "  required>
                                                    <option value='' selected>Escolha uma graduação</option>
                                                    <option value='faixa Cinza' >faixa Cinza</option>
                                                    <option value='faixa Azul Claro' >faixa Azul Claro</option>
                                                    <option value='faixa Azul Escuro' >faixa Azul Escuro</option>
