...
<body id="page-top">
    <?php
            session_start();
            if((!isset ($_SESSION['usuarioEmail']) == true) and (!isset ($_SESSION['senha']) == true) and (!isset ($_SESSION['niveis_acesso_id']) == 1))
            {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Lista de todos os alunos ATIVOS</h1>
          ...
          <!-- DataTales Example -->
            <?php
              ...
              $result_usuarios = "SELECT * FROM judo where condicao like 'ativo' LIMIT $inicio, $qnt_result_pg";
              
              $resultado_usuarios = mysqli_query($conn, $result_usuarios);

              $res = $inicio +10;
              $num_total = $conn->query("SELECT * FROM judo where condicao like 'ativo'")->num_rows;
             ...
             /* while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
              ...
              $result_pg = "SELECT COUNT(id) AS num_result FROM judo where condicao like 'ativo'";
            ...
            <div id="myModal" class="modal">
                ...
                <div class="modal-content">
                    <div class="column">
                    <img class="demo cursor" src="<?php echo "../fotos/".$essafera."_aluno.jpg" ;?>" style="width:100%" onclick="currentSlide(1)" alt="Nature and sunrise">
                    </div>
                </div>
            </div>
            <!-- Footer -->
